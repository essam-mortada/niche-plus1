...
export default function EditArticleScreen() {
  ...
  useEffect(() => {
    if (article) {
      ...
      setPublishNow(!!article.published_at);
    }
  }, [article]);
  ...
  const updateArticleMutation = useMutation({
    ...
    onSuccess: (updatedArticle) => {
      ...
      Alert.alert(
        "Success",
        `Article "${updatedArticle.title}" has been ${publishNow ? "published" : "saved as draft"} successfully!`,
        [
          {
            text: "OK",
            onPress: () => router.back(),
        ...
        >
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 8,
              backgroundColor: updateArticleMutation.isPending
                ? "#374151"
                : "#C6A15B",
              borderRadius: 20,
              flexDirection: "row",
              alignItems: "center",
              opacity: updateArticleMutation.isPending ? 0.6 : 1,
            }}
          >
            ...
            >
              {updateArticleMutation.isPending ? "Saving..." : "Update"}
            </Text>
          </TouchableOpacity>
        </View>
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  setFormData((prev) => ({
                    ...
                    title: text,
                    seo_title:
                      prev.seo_title === prev.title ? text : prev.seo_title,
                  }));
                }}
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  setFormData((prev) => ({
                    ...
                    summary: text,
                    seo_description:
                      prev.seo_description === prev.summary
                        ? text
